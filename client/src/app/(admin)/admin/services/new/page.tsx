...
export default function NewServicePage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      formDataUpload.append('serviceName', formData.name); // Send service name for SEO filename
      ...
      <div className="flex items-center justify-between gap-4 bg-surface-container-low/60 backdrop-blur-xl p-4 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] border border-outline-variant/10 shadow-sm">
        <div className="flex items-center gap-3 md:gap-5">
          ...
          <div className="flex flex-col">
             <h1 className="text-lg md:text-4xl font-headline font-bold leading-tight">خدمة جديدة</h1>
             <p className="hidden md:block text-xs text-on-surface-variant font-body">إعداد بيانات الخدمة والظهور في محركات البحث</p>
          </div>
        </div>
        <button 
           ...
           {activeTab === 'content' && (
             <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
               ...
               <div className="p-6 rounded-[2rem] bg-surface-container-low border border-outline-variant/10 h-fit space-y-4">
                  ...
                  <div className="p-3 bg-surface-container-highest rounded-xl border border-outline-variant/10 flex items-center justify-between">
                     <span className="text-[10px] md:text-sm font-bold font-body">نشر فوري</span>
                     <select
               ...
               <div className="lg:col-span-2 space-y-4 md:space-y-8">
                  <div className="p-6 md:p-12 rounded-[2rem] md:rounded-[3rem] bg-surface-container-low border border-outline-variant/10 space-y-4">
                    ...
                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-inner border border-gray-100 flex flex-col gap-0.5 max-w-lg">
                       <span className="text-[10px] md:text-[12px] text-[#202124] font-body">www.alorwi.com › ...</span>
